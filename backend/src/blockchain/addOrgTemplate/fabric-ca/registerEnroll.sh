...
function createOrgORGANIZATION_NAME_PLACEHOLDER {
	...
	mkdir -p ${PWD}/../../organizations/peerOrganizations/orgORGANIZATION_NAME_PLACEHOLDER.example.com/

	export FABRIC_CA_CLIENT_HOME=${PWD}/../../organizations/peerOrganizations/orgORGANIZATION_NAME_PLACEHOLDER.example.com/

  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:11054 --caname ca-orgORGANIZATION_NAME_PLACEHOLDER --tls.certfiles "${PWD}/fabric-ca/org-ORGANIZATION_NAME_LOWERCASE_PLACEHOLDER/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
	fabric-ca-client register --caname ca-orgORGANIZATION_NAME_PLACEHOLDER --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles "${PWD}/fabric-ca/org-ORGANIZATION_NAME_LOWERCASE_PLACEHOLDER/tls-cert.pem"
  { set +x; } 2>/dev/null

  infoln "Registering user"
  set -x
  fabric-ca-client register --caname ca-orgORGANIZATION_NAME_PLACEHOLDER --id.name user1 --id.secret user1pw --id.type client --tls.certfiles "${PWD}/fabric-ca/org-ORGANIZATION_NAME_LOWERCASE_PLACEHOLDER/tls-cert.pem"
  { set +x; } 2>/dev/null

  infoln "Registering the org admin"
  set -x
  fabric-ca-client register --caname ca-orgORGANIZATION_NAME_PLACEHOLDER --id.name orgORGANIZATION_NAME_PLACEHOLDERadmin --id.secret orgORGANIZATION_NAME_PLACEHOLDERadminpw --id.type admin --tls.certfiles "${PWD}/fabric-ca/org-ORGANIZATION_NAME_LOWERCASE_PLACEHOLDER/tls-cert.pem"
  { set +x; } 2>/dev/null

  infoln "Generating the peer0 msp"
  set -x
	fabric-ca-client enroll -u https://peer0:peer0pw@localhost:11054 --caname ca-orgORGANIZATION_NAME_PLACEHOLDER -M "${PWD}/../../organizations/peerOrganizations/orgORGANIZATION_NAME_PLACEHOLDER.example.com/peers/peer0.orgORGANIZATION_NAME_PLACEHOLDER.example.com/msp" --csr.hosts peer0.orgORGANIZATION_NAME_PLACEHOLDER.example.com --tls.certfiles "${PWD}/fabric-ca/org-ORGANIZATION_NAME_LOWERCASE_PLACEHOLDER/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:11054 --caname ca-orgORGANIZATION_NAME_PLACEHOLDER -M "${PWD}/../../organizations/peerOrganizations/orgORGANIZATION_NAME_PLACEHOLDER.example.com/peers/peer0.orgORGANIZATION_NAME_PLACEHOLDER.example.com/tls" --enrollment.profile tls --csr.hosts peer0.orgORGANIZATION_NAME_PLACEHOLDER.example.com --csr.hosts localhost --tls.certfiles "${PWD}/fabric-ca/org-ORGANIZATION_NAME_LOWERCASE_PLACEHOLDER/tls-cert.pem"
  { set +x; } 2>/dev/null
