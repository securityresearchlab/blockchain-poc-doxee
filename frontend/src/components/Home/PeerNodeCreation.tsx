import { MemberDto, UserDto } from "@/openapi";
        ...
        <Container>
            ...
            {props.member &&
                <div className="flex flex-col gap-2">
                    ...
                    <div><div className="font-semibold">Status</div>{props.member?.status}</div>
                </div>
            }
            <div className="w-full mt-8">
                {(props.member && props.member.status === MemberDto.status.AVAILABLE) &&
                    <Button text="Accept Invitation" onClick={props.handleCreatePeerNode} style="primary"></Button>
                }
